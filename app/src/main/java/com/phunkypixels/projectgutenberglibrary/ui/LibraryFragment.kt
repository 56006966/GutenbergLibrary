...
import com.phunkypixels.projectgutenberglibrary.databinding.FragmentLibraryBinding
                ...
                launch {
                    viewModel.newestError.collect { error ->
                        binding.newestEmptyText.text =
                            error ?: getString(com.phunkypixels.projectgutenberglibrary.R.string.remote_shelf_empty)
                    }
                }
                launch {
